...
export default function ExploreExperimentRegion({ children, playground, snapshot, inquiryCard, onDismissInquiryCard, onOpenInquiryEvidence, onAskAboutSelection, agent, onDispatch, t }) {
