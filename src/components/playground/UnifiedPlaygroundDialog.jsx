...
export default function UnifiedPlaygroundDialog({ open, playgroundId, host, agent, developmentMatrixDriver = null, onClose, t, initialTab = 'model', telemetry = NOOP_EXPLORATION_TELEMETRY, preserveSession = false, strictOpen = false }) {
