...
function BuildMoreDisclosure({
  ...
  return <div className="relative">
    ...
    {open && <div id="build-more-actions" data-build-more-actions className="fixed inset-x-2 inset-y-2 z-50 grid max-h-[calc(100dvh-1rem)] gap-1 overflow-y-auto overscroll-contain rounded-2xl border border-slate-200 bg-white p-2 shadow-2xl sm:absolute sm:inset-auto sm:right-0 sm:top-full sm:mt-2 sm:max-h-[calc(100dvh-6rem)] sm:w-[min(20rem,calc(100vw-1rem))] sm:max-w-[calc(100vw-1rem)]">
