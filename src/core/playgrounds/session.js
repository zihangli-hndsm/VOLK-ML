...
export const PLAYGROUND_ERROR_CODES = [
  ...
  'EXPLORATION_THREAD_INVALID',
  'EXPLORATION_THREAD_RESOURCE_LIMIT',
  'EXPLORATION_THREAD_NOT_ACTIVE',
  'EXPLORATION_THREAD_NOT_FOUND',
  'EXPLORATION_THREAD_ENTRY_NOT_FOUND',
  'EXPLORATION_THREAD_EXPERIMENT_UNAVAILABLE',
];
