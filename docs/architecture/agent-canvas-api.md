...
Dataset replacement accepts the same tabular dataset shape used by project files: non-empty row objects, feature-column names, and a target-column name. It does not upload data.
