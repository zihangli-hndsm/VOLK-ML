...
const definitions = [
  ...
  { id: 'xor-mlp-concept', datasetId: 'xor-mlp', build: ({ dataset }) => mlpClassificationPipeline('xor', dataset, { units: [12, 12], epochs: 500, batchSize: 16, learningRate: 0.05, optimizer: 'sgd' }) },
