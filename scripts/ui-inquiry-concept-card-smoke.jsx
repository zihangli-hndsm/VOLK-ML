...
const t = (key) => ({
  ...
  'playground.inquiry.controlledComparison.title': 'Controlled comparison',
  'playground.inquiry.controlledComparison.summary': 'A copied baseline and one changed factor make this comparison easier to inspect.',
