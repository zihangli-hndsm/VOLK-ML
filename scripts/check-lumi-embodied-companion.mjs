...
assert.ok(component.includes('data-lumi-context-bubble'), 'event-based contextual bubble is bounded');
assert.ok(component.includes('data-lumi-companion-open'), 'open state is machine-readable');
assert.ok(!component.includes('data-lumi-companion-state'), 'state enum is not rendered as learner-facing chrome');
